...
<div class="flex flex-col w-screen h-screen overflow-auto text-gray-700 bg-gradient-to-tr from-blue-200 via-indigo-200 to-pink-200">
    ...
    <div class="container m-4">
        <h1 class="mb-4">Ajouter un Conjoint</h1>
        @if (session('success'))
                ...
                @endif
        <form action="{{ route('account.conjoints.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Nom_Ar" name="Nom_Ar" value="{{ old('Nom_Ar') }}" required>
            </div>
    
            <div class="mb-3">
                <label for="Prenom_Ar" class="form-label">Prénom (Arabe)</label>
                <input type="text" class="form-control" id="Prenom_Ar" name="Prenom_Ar" value="{{ old('Prenom_Ar') }}" required>
            </div>
    
            <div class="mb-3">
                <label for="CNIE" class="form-label">CNIE</label>
                <input type="text" class="form-control" id="CNIE" name="CNIE" value="{{ old('CNIE') }}" required>
            </div>
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="auxiliaire_id" id="auxiliaire_id" class="form-control" required>
