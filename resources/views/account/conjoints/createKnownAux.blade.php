...
<div class="flex flex-col w-screen h-screen overflow-auto text-gray-700 bg-gradient-to-tr from-blue-200 via-indigo-200 to-pink-200">
    ...
    <form action="{{ route('account.conjoints.storeKnownAux', ['auxiliaire_id' => $auxiliaire->id]) }}" method="POST">
        @csrf
        ...
        <div class="form-group mb-3">
            <label class="col-form-label">Auxiliaire</label>
            <input type="text" class="form-control light" id="Nom_Auxiliaire" value="{{ $auxiliaire->Nom_Fr }} {{ $auxiliaire->Prenom_Fr }}" readonly>
