    ...
    <div
        ...
        <div class="px-10 mt-6">
            ...
            <div class="container m-4">
                ...
                <a href="{{ route('account.enfants.create') }}" class="btn btn-primary mb-3">Ajouter un Enfant</a>
                    ...
                    <tbody>
                        @forelse($enfants as $enfant)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('account.enfants.show', $enfant->id) }}" class="btn btn-info m-2">Voir</a>
                                    <a href="{{ route('account.enfants.edit', $enfant->id) }}" class="btn btn-warning m-2">Modifier</a>
                                    <form action="{{ route('account.enfants.destroy', $enfant->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger m-2"
                                            onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet enfant ?');">Supprimer</button>
                                    </form>
                                </td>
                            </tr>
                        @empty
