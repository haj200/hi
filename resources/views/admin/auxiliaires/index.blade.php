...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded-top p-4 d-flex justify-content-between align-items-center">
                    <h4>Liste des Auxiliaires</h4>
                    <a href="{{ route('auxiliaires.create') }}" class="btn btn-primary">Ajouter un Auxiliaire</a>
                </div>
            </div>
            @if(session('success'))
        ...
        @endif
                ...
                <table class="table table-striped-columns m-4">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('auxiliaires.show', $auxiliaire->id) }}" class="btn btn-outline-info">Voir</a>
                                <a href="{{ route('auxiliaires.edit', $auxiliaire->id) }}" class="btn btn-light">Modifier</a>
                                <form action="{{ route('auxiliaires.destroy', $auxiliaire->id) }}" method="POST" style="display: inline-block;" >
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-outline-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette élément! ?')">Supprimer</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
           ...
           @else
           <p>aucun auxiliaire n'est enregistré...</p>     
                @endif
