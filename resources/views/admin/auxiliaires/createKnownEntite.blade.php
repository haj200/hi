    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                {{-- Formulaire pour ajouter un auxiliaire --}}
                <form action="{{ route('auxiliaires.store') }}" method="POST" class="mt-4">
                    @csrf
                    
                    {{-- Affichage de l'entité territoriale correspondante --}}
                    <div class="form-group mb-3">
                        <label for="entiteterritorielle_id" class="col-sm-2 col-form-label">Entité Territoriale Correspondante</label>
                        <div class="col-sm-10">
                            <input type="text" name="entiteterritorielle_id" class="form-control" id="entiteterritorielle_id" value="{{ $entite->Nom }}" readonly>
                            <input type="hidden" name="entiteterritorielle_id" value="{{ $entite->id }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="Nom_Fr" class="form-control" id="Nom_Fr" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="Prenom_Fr" class="form-control" id="Prenom_Fr" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="Nom_Ar" class="form-control" id="Nom_Ar" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="Prenom_Ar" class="form-control" id="Prenom_Ar" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="CNIE" class="form-control" id="CNIE" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="url_photo" class="form-control" id="url_photo" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="date_de_recrutement" class="form-control" id="date_de_recrutement" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="pensionne" class="form-select" id="pensionne" required>
