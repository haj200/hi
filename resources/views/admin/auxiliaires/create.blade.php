...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <form action="{{ route('auxiliaires.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="url_photo" class="form-control" id="url_photo" >
                    </div>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    <label for="entiteterritorielle_id" class="col-sm-2 col-form-label">Entité Territorielle Correspondante</label>
                    <div class="col-sm-10">
                        <select name="entiteterritorielle_id" class="form-select" id="entiteterritorielle_id" required>
                            <option value="">-- Sélectionnez l'entité Territorielle --</option>
                            @foreach ($entites as $entite)
                                <option value="{{ $entite->id }}" {{ old('entite') == $entite->id ? 'selected' : '' }}>
                                    {{ $entite->Nom }}   ------   {{ $entite->Nom_Ar }}</option>
