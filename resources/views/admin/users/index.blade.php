    ...
    @endif
                ...
                <table class="table table-striped-columns">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">{{ $user->Nom_Fr }}</th>
                            <td>{{ $user->Prenom_Fr }}</td>
                            <td>{{ $user->Nom_Ar }}</td>
                            <td>{{ $user->Prenom_Fr }}</td>
                            <td>
                                <a href="{{ route('users.show', $user->id) }}" class="btn btn-outline-warning">Voir</a>
                                <a href="{{ route('users.edit', $user->id) }}" class="btn btn-light">Modifier</a>
            ...
            @else 
                <p>aucune Entité territorielle enregistrée...</p>
                @endif
            <div class="container-fluid pt-4 px-4">
