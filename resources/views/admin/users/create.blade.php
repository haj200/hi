        ...
        <div class="content">
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Prenom_Fr" class="form-control" id="Prenom_Fr" value="{{ old('Prenom_Fr') }}"
                            required >
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Prenom_Ar" class="form-control" id="Prenom_Ar" value="{{ old('Prenom_Ar') }}"
                            required >
                    </div>
                </div>
