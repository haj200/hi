        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded-top p-4 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('users.index') }}" class="btn btn-primary m-2">Annuler</a>
                </div>
            </div>
            <!-- Navbar End -->
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Nom_Fr" class="form-control" id="Nom_Fr" value="{{ old('Nom_Fr', $user->Nom_Fr) }}" required>
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Prenom_Fr" class="form-control" id="Prenom_Fr" value="{{ old('Prenom_Fr', $user->Prenom_Fr) }}" required>
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Nom_Ar" class="form-control" id="Nom_Ar" value="{{ old('Nom_Ar', $user->Nom_Ar) }}" required>
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Prenom_Ar" class="form-control" id="Prenom_Ar" value="{{ old('Prenom_Ar', $user->Prenom_Ar) }}" required>
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    <label for="password" class="col-sm-2 col-form-label">Mot de passe (Laissez vide pour ne pas changer)</label>
                    <div class="col-sm-10">
