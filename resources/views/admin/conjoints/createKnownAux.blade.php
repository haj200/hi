...
<body>
    <div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="" class="dropdown-item">Leurs Conjoints</a>
        ...
        <div class="content">
            ...
            {{-- Form to Add a New Conjoint --}}
            <form action="{{ route('conjoints.storeKnownAux', ['auxiliaire_id' => $auxiliaire->id]) }}" method="POST">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="CNIE" class="form-control" id="CNIE" value="{{ old('CNIE') }}" required>
                </div>
            
                <div class="form-group mb-3">
                    <label class="col-sm-2 col-form-label" >Auxiliaire</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control dark"  id="Nom_Auxiliaire" value="{{ $auxiliaire->Nom_Fr }} {{ $auxiliaire->Prenom_Fr }}" readonly>
                </div>
                <input type="hidden" name="auxiliaire_id" value="{{ $auxiliaire->id }}">
                </div>
