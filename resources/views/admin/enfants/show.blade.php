        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded-top p-4 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('enfants.index') }}" class="btn btn-primary m-2">Retour</a>
                </div>
            </div>
                ...
                <div class="card m-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Informations de l'Enfant</h5>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">{{ $enfant->Nom_Fr }} {{ $enfant->Prenom_Fr }}</h5>
                        <p class="card-text"><strong>Nom (Arabe):</strong> {{ $enfant->Nom_Ar }}</p>
                        <p class="card-text"><strong>Prénom (Arabe):</strong> {{ $enfant->Prenom_Ar }}</p>
                        <p class="card-text"><strong>Date de Naissance:</strong> {{ $enfant->Date_De_Naissance }}</p>
                        <p class="card-text"><strong>Auxiliaire:</strong> {{ $enfant->auxiliaire->Nom_Fr }} {{ $enfant->auxiliaire->Prenom_Fr }}</p>
                    </div>
                    
                    <div class="bg-secondary  m-4 p-4 flex justify-content-between card-footer">
                        <a href="{{ route('enfants.edit', $enfant->id) }}" class="btn btn-warning m-4">Modifier</a>
                        <a href="{{ route('enfants.index') }}" class="btn btn-info m-4">retour à la liste</a>
