...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <form action="{{ route('enfants.storeKnownAux', ['auxiliaire_id' => $auxiliaire->id]) }}" method="POST">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                    <input type="text" id="Nom_Auxiliaire" class="form-control dark" value="{{ $auxiliaire->Nom_Fr }} {{ $auxiliaire->Prenom_Fr }}" readonly>
                </div>
