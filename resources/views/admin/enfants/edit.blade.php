...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        {{-- Formulaire pour modifier un enfant --}}
        <form action="{{ route('enfants.update', $enfant->id) }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="Nom_Fr" class="form-control" id="Nom_Fr" value="{{ old('Nom_Fr', $enfant->Nom_Fr) }}" required>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="Prenom_Fr" class="form-control" id="Prenom_Fr" value="{{ old('Prenom_Fr', $enfant->Prenom_Fr) }}" required>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="Nom_Ar" class="form-control" id="Nom_Ar" value="{{ old('Nom_Ar', $enfant->Nom_Ar) }}" required>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="Prenom_Ar" class="form-control" id="Prenom_Ar" value="{{ old('Prenom_Ar', $enfant->Prenom_Ar) }}" required>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-sm-10">
                    <input type="date" name="Date_De_Naissance" class="form-control" id="Date_De_Naissance" value="{{ old('Date_De_Naissance', $enfant->Date_De_Naissance) }}" required>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="col-sm-10">
                    <select name="auxiliaire_id" id="auxiliaire_id" class="form-select" required>
                        ...
                        <option value="{{ $auxiliaire->id }}" {{ (old('auxiliaire_id', $enfant->auxiliaire_id) == $auxiliaire->id) ? 'selected' : '' }}>
