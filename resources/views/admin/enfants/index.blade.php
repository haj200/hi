            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Prénom En Français</th>
                        <th scope="col">Nom En Arabe</th>
                        <th scope="col">Prénom En Arabe</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('enfants.show', $enfant->id) }}" class="btn btn-info btn-sm">Voir</a>
                            <a href="{{ route('enfants.edit', $enfant->id) }}" class="btn btn-warning btn-sm">Modifier</a>
                            <form action="{{ route('enfants.destroy', $enfant->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de supprimer cet élement!');">
                                @csrf
                                @method('DELETE')
