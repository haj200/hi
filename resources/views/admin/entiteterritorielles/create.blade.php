        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded-top p-4 d-flex justify-content-between align-items-center">
                    <h4>Créer une Nouvelle Entité Territoriale</h4>
            ...
            {{-- Formulaire pour ajouter une entité territoriale --}}
            <form action="{{ route('entiteterritorielles.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Nom_Ar" class="form-control" id="Nom_Ar"
                            value="{{ old('Nom_Ar') }}" required>
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="type" class="form-select" id="type" required>
                            ...
                            @foreach (['Province', 'Pachalik', 'Caidat', 'Cercle', 'Annexe'] as $type)
                ...
                <div class="form-group mb-3">
                    <label for="managed_by" class="col-sm-2 col-form-label">Géré par</label>
                    <div class="col-sm-10">
                        <select name="managed_by" class="form-select" id="managed_by" required>
                            <option value="">-- Sélectionnez un utilisateur --</option>
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}"
                                    {{ old('managed_by') == $user->id ? 'selected' : '' }}>
